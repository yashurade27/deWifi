    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden">
        ...
        <div className="container relative px-4 md:px-6 mx-auto">
          <motion.div {...fadeInUp} className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-gray-300 hover:bg-gray-50 px-8 py-6 text-lg"
          ...
          >
            {STATS.map((stat, idx) => (
              <div key={idx} className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200 p-6 text-center">
                <div className="text-3xl md:text-4xl font-black text-[#0055FF] mb-2">
                  {stat.value}
                </div>
            ...
            {FEATURES.map((feature, idx) => (
              ...
              >
                <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mb-4">
                  <feature.icon size={24} className="text-[#0055FF]" />
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {USE_CASES.map((useCase, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: idx * 0.1 }}
                className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl border border-gray-200 p-8 hover:shadow-lg transition-all group"
              >
                <div className="flex items-start gap-4">
                  <div className="w-14 h-14 bg-white rounded-xl flex items-center justify-center shrink-0 shadow-sm group-hover:scale-110 transition-transform">
                    <useCase.icon size={28} className="text-[#0055FF]" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-gray-900 mb-2">{useCase.title}</h3>
                    <p className="text-gray-600 mb-3">{useCase.description}</p>
                    <div className="inline-flex items-center gap-2 text-sm font-semibold text-[#0055FF] bg-white px-3 py-1.5 rounded-lg">
                      <TrendingUp size={16} />
                      {useCase.stats}
                    </div>
                  </div>
        ...
        <div className="container px-4 md:px-6 mx-auto">
          ...
          <div className="mt-12 text-center">
            <p className="text-sm text-gray-600">
              ...
              <br />
              Need a custom plan? <a href="#contact-form" className="text-[#0055FF] font-semibold hover:underline">Contact us</a> for tailored solutions.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-6 mx-auto max-w-4xl">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6 text-center">
            <div className="flex flex-col items-center">
              ...
              <a href="mailto:enterprise@dewifi.com" className="text-sm text-gray-600 hover:text-[#0055FF]">
                enterprise@dewifi.com
              </a>
            </div>
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mb-3">
                <Phone size={20} className="text-[#0055FF]" />
              </div>
              <h4 className="font-semibold text-gray-900 mb-1">Call Us</h4>
              <a href="tel:+918800123456" className="text-sm text-gray-600 hover:text-[#0055FF]">
                +91 88001 23456
              </a>
            </div>
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-gray-600">24/7 for Enterprise</p>
            </div>
          </div>
        </div>
      </section>
