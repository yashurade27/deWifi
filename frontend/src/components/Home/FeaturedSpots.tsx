...
export const FeaturedSpots = () => {
    ...
    return (
        <section className="w-full py-24 bg-[#050511] text-white overflow-hidden">
            <div className="container max-w-7xl mx-auto px-6 md:px-8">
                ...
                >
                    ...
                    <Button className="bg-white text-black hover:bg-gray-100 rounded-full px-7 py-6 text-base font-bold shrink-0 transition-all duration-300">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                    {MOCK_SPOTS.map((spot, i) => (
                        ...
                        >
                            <Card className="bg-[#0d0d20] border border-gray-800 text-white overflow-hidden hover:border-[#0055FF]/60 transition-all duration-300 group rounded-3xl h-full flex flex-col">
                                <div className="relative h-48 overflow-hidden shrink-0">
                                    ...
                                    />
                                    <div className="absolute inset-0 bg-gradient-to-t from-[#0d0d20]/60 to-transparent" />
                                ...
                                <CardContent className="p-5 flex-1">
                                    ...
                                    <div className="flex flex-wrap gap-1.5">
                                        {spot.amenities.map((am, j) => (
                                            <Badge key={j} variant="secondary" className="bg-white/5 text-gray-400 border border-white/10 text-xs font-semibold hover:bg-white/10">
                                                {am}
                                            </Badge>
                                        ))}
                                    </div>
                                ...
                                <CardFooter className="p-5 pt-0 flex justify-between items-center border-t border-white/5">
                                    <div>
                                        <span className="text-2xl font-black text-white">₹{spot.price}</span>
